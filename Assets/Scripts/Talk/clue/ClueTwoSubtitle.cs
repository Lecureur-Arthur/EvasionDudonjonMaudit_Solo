...
public class ClueTwoSubtitle : MonoBehaviour
{
    public GameObject character;
    public AudioSource audioSource;
    public AudioClip audioClip;
    public TwoSubtitle subtitleScript;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player") && !isPlaying)
        {
            ...
            if (audioClip != null)
            {
                ...
                // Déclenche l'affichage des sous-titres à partir de TwoSubtitle
                if (subtitleScript != null)
                {
                    // Appelle la méthode coroutine de TwoSubtitle
